    ...
    <main className="min-h-screen h-full flex flex-col w-full">
      ...
      <div className="relative overflow-hidden my-4">
        <section className="flex flex-col items-center rounded-2xl h-[90vh] bg-[#F6F6F8] mx-8  border p-4">
          ...
          <img src="/cursor-4.png" className="absolute z-20 right-10 bottom-10 h-48 w-auto mr-12 mb-12 -rotate-12" />
          <img src="/linkedin.png" className="absolute z-20 left-10 bottom-10 h-48 w-auto ml-6 mb-12 rotate-12" />
          <img src="/website-1.png" className="absolute z-0 right-1/4 -top-24 h-72 w-auto ml-24 mb-12 rotate-12" />
