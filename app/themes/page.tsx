    ...
    <main className="flex w-full items-center justify-center">
      <div className="flex min-h-screen w-full max-w-[1400px] px-1.5 pb-12 pt-3 capitalize sm:px-8">
        <div className="flex w-full flex-col items-center rounded-xl border py-12">
          ...
          <p className="my-2 hidden lowercase text-slate-600 sm:block sm:text-sm lg:text-base">
          ...
          >
            ...
            >
              {[
                {
                  themeName: "slate ",
                  image: "/themes/slate.png",
                  preference: "",
                  premimum: false,
                },
                {
                  themeName: "vivid",
                  image: "/themes/vivid.png",
                  preference: "",
                  premimum: false,
                },
                {
                  themeName: "bentodark",
                  image: "/themes/zenith-bento.png",
                  preference: "",
                  premimum: false,
                },
                {
                  themeName: "windows-95",
                  image: "/themes/windows-95.png",
                  preference: "",
                  premimum: false,
                },
                {
                  themeName: "block",
                  image: "/themes/block.png",
                  preference: "",
                  premimum: false,
                },
                {
